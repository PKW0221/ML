...
Original file is located at
    https://colab.research.google.com/drive/1V8p6V2ASLbsssvu0zxkvR87XRUSie40h
"""
...
class SVMClassifier:
    ...
    def fit(self, x, y):
        ...
        # 문제 1: y값을 SVM 계산에 활용해주기 위하여 0에 해당하는 y값들을 -1로 변환
        y_ =  y  
    ...
    def get_accuracy( y_true, y_pred):
        ...
        문제 7:
            ...
            주의사항: 
            라벨의 개수는 0,1로 이진 분류가 아니라, 3개 이상일 수 있습니다.
            라벨이 3개 이상인 경우 정상적으로 작동하지 않으면, 본 함수를 풀어서 얻게되는 점수는 없습니다.
        """
        len_data=len(y_true)
        True_NP=[]
